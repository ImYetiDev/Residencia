...
<div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{route('Usuario.index')}}" class="nav-item nav-link"><i class="bi bi-people-fill"></i>Usuarios</a>
                    <a href="{{route('Vivienda.index')}}" class="nav-item nav-link"><i class="bi bi-building"></i>Viviendas</a>
                    <a href="{{route('ZonasComun.index')}}" class="nav-item nav-link"><i class="bi bi-shop"></i>Zonas Comunes</a>
                </div>
            </nav>
        </div>
