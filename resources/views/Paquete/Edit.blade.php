                ...
                <div class="bg-secondary rounded h-100 p-4">
                    ...
                    <form action="{{ route('Paquete.update', $paquete->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select id="vivienda_id" value="{{old('vivienda_id')}}"name="vivienda_id" class="form-control">
                                <option>------Seleccionar------</option>
                                @foreach($paquete as $paquetes)
                                <option value="{{ $paquetes->vivienda->id }}">{{ $paquetes->vivienda->nomenclatura }}</option>
                                @endforeach
                            </select>
